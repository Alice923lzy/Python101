...
def niceending(): # nice endings, YOU know the truth or have a happy lifetime
    """
    helper function to decrease the Complexity
    """
    docLive = input().upper()
    while (docLive != "YES" and docLive != "NO"): #check validity
        print(errStr)
        docLive = input().upper()
    ...
    if docLive == "YES":
        ...
        while (badDoctor != "KILL" and badDoctor != "LEAVE"): #check validity
            print(errStr)
            badDoctor = input().upper()

        if badDoctor == "KILL":
            print("You chose to kill. You put a bullet into the heart of the doctor. He didn't suffer. THE END. ") # so coldheart
...
def badending(): # bad endings, YOU don't know the truth 
    """
    helper function to decrease the Complexity
    """
    lifeChoice = input().upper()
    while (lifeChoice != "LEAVE" and lifeChoice != "STAY"): #check validity
        print(errStr)
        lifeChoice = input().upper()
...
def guard(): #meet guard
    ...
    gua = input().upper()
    while (gua != "H" and gua != "KILL"): #check validity
        print(errStr)
        gua = input().upper()

    if gua == "H":
        print("You choose to hide. BAD choice. The guard didn't find you. But, he found the doctor who you killed. High alert raises, and you don't have the key to pass the last gate. So, they found you. They take you back to the cell and charge you with murder. FAIL.")  # fail ending
        ...
        badending() # bad ending gather to one function



def doctor(): # meet doctor
    """
    helper function to decrease the Complexity
    """
    docKill = input().upper()
    while(docKill != "KILL" and docKill != "KIDNAP"): #check validity
        print(errStr)
        docKill = input().upper()
    ...
    if docKill == "KILL":
        ...
        guard()   #meet guard trigger alike path, so gather to one function
        ...
        while (docBelieve != "B" and docBelieve != "N"): #check validity
            print(errStr)
            docBelieve = input().upper()
        ...
        if docBelieve == "B":
            ...
            docStay = input().upper()
            while (docStay != "WAIT" and docStay != "KILL"): #check validity
                print(errStr)
                docStay = input().upper()
            ...
            if docStay == "WAIT":
                ...
                niceending() # nice ending gather to one function, all nice ending means you know the truth
...
def main():
    """
    this is the beginning and the end greetting of the game.
    ...
    print("Welcome to plain text advanture game. All input requirement are not case-sensetive.\n\n")
    ...
    hallway = input().upper()
    while (hallway != "L" and hallway != "R"): #check validity
        print(errStr)
        hallway = input().upper()
    ...
    if hallway == "L":
        ...
        guard = input().upper()
        while (guard != "KILL" and guard != "AVOID"): #check validity
            print(errStr)
            guard = input().upper()
        ...
        if guard == "KILL":
            ...
            docKill = input().upper()
            while (docKill != "D" and docKill != "R"): #check validity
                print(errStr)
                docKill = input().upper()
            ...
            if docKill == "D":
                ...
                while (guardkill != "H" and guardkill != "KILL"): #check validity
                    print(errStr)
                    guardkill = input().upper()
            ...
            doctor() #meet doctor, call helper function

    print("Thanks for playing this advanture game. If you want to play again to see other endings, please enter \"R\"") # end greeting to player
    again = input().upper()
    while (again != "R"): #check validity
        print(errStr)
        again = input().upper()
    if again == "R": # let's play again
        main()
